...
class LesionVolumeLocalisationMNI(object):
    def __init__(self, class_names, native_space=False):
        ...
        atlas_label_map_path = '/vol/biomedic3/cpicarr1/template_integration/LesionLocalisationAnalysis/mean_template_7_u_lobe_atlas_ero_dil.nii.gz'
    ...
    def localise_lesion_volumes(self, label_map, atlas_label_map, brain_mask):
        # class_names is a variable given on the constructor
        ...
        for roi_name, roi_label in self.roi_dictionary.items():
            ...
            # Why do we use sitk.Mask(region_mask, brain_mask) and not just region_mask??
